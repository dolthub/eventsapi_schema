...
// file: dolt/services/eventsapi/v1alpha1/event_constants.proto
...
export interface ClientEventTypeMap {
  TYPE_UNSPECIFIED: 0;
  INIT: 1;
  STATUS: 2;
  ADD: 3;
...
export const MetricID: MetricIDMap;

export interface AttributeIDMap {
  ATTRIBUTE_UNSPECIFIED: 0;
  REMOTE_URL_SCHEME: 2;
}

export const AttributeID: AttributeIDMap;
